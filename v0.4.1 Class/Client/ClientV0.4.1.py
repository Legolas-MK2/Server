...
class Client:
    def __init__(self):
        self.option_rsa_client_client = True
        self.option_rsa_client_server = True
        self.option_aes_client_client = True
        self.option_aes_client_server = True
        self.option_multi_client = True
        self.option_server_command = {"#C": self.close()}
    def server_command(self,command):
        if command not in self.option_server_command:
            return
        self.option_server_command[command]
