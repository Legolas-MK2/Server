...
def switch(Befehl,parameter1 = "", parameter2 = ""):
    global Befehl_update, Befehl_send, Befehl_close, Befehl_clear, Befehl_online
...
if __name__ == "__main__":
    ...
    while len(Name) < 1:
        ...
        if Name == "Server" or " " in Name:
            ...
            client_socket.send(cipher.AES_encrypt_text(bytes(Name, "utf-8")))
